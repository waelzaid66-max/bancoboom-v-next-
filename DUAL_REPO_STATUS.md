# حالة مستودع BANCO القانوني

**آخر تحديث تشغيلي:** 2026-08-09
**المصدر القانوني الوحيد:** https://github.com/waelzaid66-max/bancoboomstor
**الفرع التشغيلي:** `main` بعد نجاح CI على SHA الإصدار نفسه.

> كل ما تحت عنوان «السجل التاريخي المؤرشف» يوثّق حالة 2026-07-09 فقط.
> لا تستخدم روابطه أو SHAs أو tags للنشر الحالي، ولا تعتبر `aws-virgen` أو أي
> مستودع سابق مصدرًا للكود.

## السجل التاريخي المؤرشف — غير صالح للتنفيذ

**تاريخ اللقطة:** 2026-07-09
**النطاق التاريخي:** مستودعان قبل توحيد `bancoboomstor`.

| الريبو | الرابط | الدور |
|--------|--------|-------|
| **متقاعد — سجل تاريخي** | https://github.com/waelzaid66-max/-BANCO-CA-OOM- | كان كود + CI + تقارير + GCP + Replit |
