...
export const GetMessagesResponse = zod.object({
  ...
  "client_message_id": zod.string().uuid().nullable().describe('Stable identifier generated by the sender for one logical send. Retrying the same identifier returns the original message without incrementing unread counters or notifications again.'),
  "body": zod.string(),
  "is_mine": zod.boolean(),
  "created_at": zod.string(),
...
export const SendMessageBody = zod.object({
  "body": zod.string(),
  "client_message_id": zod.string().uuid().nullish().describe('Stable identifier for one logical send. Reuse it on network retry so the operation is idempotent.'),
