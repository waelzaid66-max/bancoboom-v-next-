...
>
> ## ⓪·٢ تقسيم العمل بين الوكيلين — **النسخة السارية**
> ## 🤝 [`WORK-SPLIT-TWO-AGENTS-V2-AR.md`](./WORK-SPLIT-TWO-AGENTS-V2-AR.md)
> ملكية **بالنطاق** مش بالملف · بروتوكول حجز في القناة · قواعد المونوريبو ·
> الدمج والنشر والميديا · المترتب على كل قرار.
> **يلغي** `AGENT-WORK-ORDERS-PARALLEL-AR.md` بعد تصادم 2026-08-02.
>
