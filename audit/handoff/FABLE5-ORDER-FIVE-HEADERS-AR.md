...
🔴 تجاوز من المالك (2026-08-03) — يعلو على الصورة:
  ⛔ احذف "GLOBAL VEHICLE MARKETPLACE" نهائياً. المالك: «دي غلط، ملهاش عوزة ولا قيمة —
     الهيدر بيدل عن كل ده». اللوجو B-OOM CAR يقولها بالفعل.
  ⛔ ولا تعيدها لأن الصورة تعرضها. هذا أمر مكتوب يعلو على التصميم.
  ✅ سطر "Cars • Bikes • Trucks • Marine • Air" يبقى — هو الذي يوضّح النطاق.

الشرائح:
  pinned = قائمة · B-OOM CAR + powered by · جرس(شارة) · بروفايل · بحث · شريط الأنواع
  scroll = Cars•Bikes•Trucks•Marine•Air · صف الثقة الأربعة · الإحصاءات
           (⛔ بلا عنوان "GLOBAL VEHICLE MARKETPLACE")
...
# ٦-ب) برومبت ٦ — المستطيلات الخمسة · ⏸️ بعد الاسترجاع

```
⛔ لا تبدأ قبل أن أنهي أنا الاسترجاع.

السبب: صفحة الاكتشاف مبتورة. وكيل سابق شال منها 338 سطر في كوميت واحد
(7e73e5a · 07-12) وكتب "NOT to be added back". خمس خدمات لسه مفقودة:
Recent searches · Popular brands · Saved searches · Trending · Recently viewed.
الدليل والأصل: INVESTIGATION-DISCOVER-DOWNGRADE-AR.md + restore/

⛔ ممنوع تلميع نسخة مبتورة. أنا أرجّع الأصل، ثم تبوّلش أنت فوقه.

عند الإذن — الملف الوحيد components/SearchDiscover.tsx:
  1. ⑥ الخرائط يدخل نظام إخوته: حدود rgba(255,255,255,0.08) · marginTop 12 · علامة مائية.
     ⛔ لا تحذف mapGlow — ينتقل ولا يُمحى.
  2. ⛔ صفر #hex في الملف. البنوك BANKS_ACCENT + SECTION_GRADIENT.banks من lib/sectionTheme.
     ⛔ البنوك تبقى زرقاء — استثناء موثّق.
  3. SECTION_GRADIENT المكرّر (:47-52) يُستورد من lib/sectionTheme.
  4. إيقاع رأسي واحد + ارتفاع صف موحّد للخمسة.
  5. أهداف اللمس ≥44px (الشارة اليوم 42×42).
  ⛔ كل testID يبقى — حرّاس تقرأ النص الخام (section-miniapp-guard:1258,1375,1451,1998).
```

---

# ٦-جـ) برومبت ٧ — قسم استيراد السيارات · ⏸️ بعد قرار المالك

```
⛔ لا تبدأ قبل أن يبعت المالك تصميم قسم الاستيراد.

الحالة المتحقَّقة: القسم سليم وظيفياً — صفر ملفات محذوفة · التسعة زراير موصّلة
· الدعم ينشئ تذكرة حقيقية. المُزال أربعة ادعاءات فقط: شارة Integration-ready ·
"8+" مزادات (القائمة ثمانية بالضبط) · "21" دولة (لا قائمة لها) · قوس قزح المراحل.

الملفات: app/import/** · components/import/OrderDocuments.tsx
⛔ بوليش بصري فقط. ⛔ ممنوع لمس المسارات والمعالجات.
⛔ ولا رقم مكتوب بإيدك — الرقمان المُزالان كانا مخترعين فعلاً، ولن يعودا.
⛔ الأحمر موحّد بالفعل (sectionAccent("car")) — لا تفكّه.
```
