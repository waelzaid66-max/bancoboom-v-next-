...
| Render claims could silently become unreachable | side candidates `a8e2ba5`, `2934e3d`; VNX-04 shared-shell census | mobile render suites/registry | VNX-01 registry plus VNX-04 results/nav, VNX-05A Cars, VNX-05B Property, and VNX-05C Stay mounting; 8 suites, 60 tests at `e85cd39` |
...
| Controls/identity hidden by empty/error overlay | Property `9d402d4`, Stay `d098047`, Facilities `ca19018` | pinned vs scrolling header slices/list overlays | VNX-04 proves overlay/list coexist; VNX-05B proves Property pinned controls/empty scrolling slice (8/8), and VNX-05C proves the same Stay invariant plus real collapse (7/7); both exact-SHA CI runs green. Facilities and combined Property/Stay state/device matrices remain required |
