...
| Render claims could silently become unreachable | side candidates `a8e2ba5`, `2934e3d`; VNX-04 shared-shell census | mobile render suites/registry | VNX-01 registry plus VNX-04 results/nav and VNX-05A Cars mounting; 6 suites, 45 tests at `e3f92c2` |
...
| Controls/identity hidden by empty/error overlay | Property `9d402d4`, Stay `d098047`, Facilities `ca19018` | pinned vs scrolling header slices/list overlays | VNX-04 proves the opaque overlay and previous list coexist; interactive section chrome remains outside it; per-section state/pressability matrix still required |
