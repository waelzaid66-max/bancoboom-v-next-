...
| P0 | Facilities/Materials identities | known lineages and hidden overlay pattern | `RECOVER` only after independent archaeology | Empty/error/scrolling/pinned state proof |
