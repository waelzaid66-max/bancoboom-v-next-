...
| P0 active | Maps runtime | `127e3d7`, `a4c1eb0`, `34709b4`, `12ce4f4`; VNX-06A base native/web/geometry blobs `5017d4b`/`3d24c9f`/`0b4ce53`; repair `0214983`, CI `31454274073` | Prior `ALREADY_PRESERVED` claim narrowed: web draw area was `ORPHANED`; geometry, clear viewport, active-area refresh, and cache ordering were `MUTATED`. VNX-06A `RECOVERED/MODERNIZED` only that reproduced slice | Real browser/WebView/provider/Android/iOS; large-result and latency; map/list/MapsHub/five-domain journeys; MapPinPicker persistence/accessibility/device certification |
