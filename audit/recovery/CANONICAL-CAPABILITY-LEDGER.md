...
| Stay full `BookingStaysApp` integration | `UNPROVEN` | Header is frozen separately at `e85cd39`; mount API-backed loading/results/empty/error, booking/map/taxonomy, responsive, accessibility, and device journeys |
| Five-section combined integration | `CONFLICT_DAMAGED/UNPROVEN` | All five standalone headers are frozen; mount current loading/results/empty/error, facets, scroll lifecycle, map latch, and section isolation without rewriting `SectionSearchApp` |
