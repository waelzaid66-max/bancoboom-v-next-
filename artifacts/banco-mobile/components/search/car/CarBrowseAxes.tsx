  ...
  return (
    <View style={styles.root} testID="cars-host-axes">
      ...
      >
        ...
        <Pressable
          onPress={() => press(() => onSelectListingMode("all"))}
          style={[
            styles.modeChip,
            { backgroundColor: listingMode === "all" ? ACCENT : SURFACE },
          ]}
        ...
        >
          <Feather
            name="layers"
            size={14}
            color={listingMode === "all" ? "#FFFFFF" : colors.mutedForeground}
          />
          <AppText
            style={[
              styles.chipText,
              { color: listingMode === "all" ? "#FFFFFF" : colors.foreground },
            ]}
          >
